...
# The host an org points its help site's domain at by CNAME, when something other than the app itself serves the
# sites. Unset, the domain dialog shows the app's own domain.
