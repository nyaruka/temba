...
urlpatterns += [
    ...
    # the path the websockets endpoints were served at before they moved under ti/, kept while callers are switched
    # over - it has to come first, since with a name used twice reverse() yields the mount defined last
